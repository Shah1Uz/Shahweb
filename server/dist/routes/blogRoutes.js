...
router.post('/:id/react', blogController_1.reactToBlogPost);
// Admin
...
router.patch('/:id/stats', authMiddleware_1.authenticate, authMiddleware_1.requireAdmin, blogController_1.updateBlogStats);
